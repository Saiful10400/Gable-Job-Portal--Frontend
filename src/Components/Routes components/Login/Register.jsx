        ...
        <div className="h-[90vh] relative">
            ...
            <h1 className="text-5xl font-bold mb-20">Rigistration</h1>
              ...
              <div className="text-xl">
                <input checked className="scale-150 accent-green-500 " type="checkbox" id="condition" />
                <label htmlFor="condition"> I agree to the terms and conditions of <Link className="underline text-green-500">Privacy Policy.</Link></label>
              </div>
              <div className="flex gap-10 items-center">
                <button type="submit" className="btn w-[40%] text-lg h-20 bg-[#38A745] text-white">Registration</button>
                <Link className="text-lg font-bold" to={"/login"}>Login</Link>
              </div>
                </form>
            </div>
            <div className="">
                <img className="w-full h-full object-contain" src={registrarionimg} alt="" />
            </div>
