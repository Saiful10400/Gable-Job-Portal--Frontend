  ...
  return (
    <div className="bg-[#D0FED5] min-h-[300px] ">
      ...
      <div>
       ...
       <p className="text-[#393838] font-normal text-sm  lg:text-lg mb-16">
         Jobs, Employment & Future Career Opportunities
       </p>
       </div>
       <div className="lg:block hidden">
       <form className="h-[70px] w-full lg:w-[700px]  relative z-1 gap-3 lg:gap-0  flex flex-col lg:flex-row">
            <input placeholder="Job Title" className="h-full w-full py-3 lg:py-0 focus:outline-none text-base font-lg pl-8" type="text" />
            <input placeholder="Job Catagory" className="h-full w-full py-3 lg:py-0 focus:outline-none text-base font-lg pl-8 border-l" type="text" />
            <button className="h-full bg-gradient-to-r from-[#38A745] from-0% py-3 lg:py-0  to-[#4CCE5B] to-60% lg:w-[400px] text-lg font-normal text-white">Search</button>
